...
• Sen, drzemki, pobudki
• Podane leki (godzina, dawka, historia)
• Pieluchy — mokre, brudne
...
Trial nie wymaga karty. Po 14 dniach dalej używasz podstawowej wersji.

✅ ZAWSZE ZA DARMO
• Podstawowe zapisywanie temperatury, karmień, snu, leków
• Krytyczne alerty bezpieczeństwa (gorączka u niemowlęcia <3 miesięcy, temperatura ≥40,5°C, kryzys odwodnienia)
• Sync między urządzeniami przez konto Google
...
• Polskiego Towarzystwa Pediatrycznego (KOMPAS GORĄCZKA)
• American Academy of Pediatrics
• Norm wzrostu WHO

Wytyczne aktualizowane wraz z rekomendacjami — nie porady z forum.

⚠️ WAŻNE
Spokojny Rodzic NIE jest wyrobem medycznym. NIE wylicza dawek leków (dawkę zawsze sprawdź w ulotce, u farmaceuty lub pediatry). NIE diagnozuje i NIE zastępuje lekarza — pomaga Ci obserwować dziecko i mieć dane pod ręką na wizytę.
...
Robię tę apkę sam. Każda opinia bardzo mi pomaga.
...
• Stillen und Flaschenmahlzeiten
• Schlaf, Nickerchen, Aufwachzeiten
• Verabreichte Medikamente (Uhrzeit, Dosis, Verlauf)
• Windeln — nass, schmutzig
...
Die Testphase erfordert keine Kreditkarte. Nach 14 Tagen nutzen Sie weiterhin die Basisversion.

✅ IMMER KOSTENLOS
• Grundlegendes Erfassen von Temperatur, Mahlzeiten, Schlaf, Medikamenten
• Kritische Sicherheitshinweise (Fieber bei Babys unter 3 Monaten, Temperatur ≥40,5°C, Dehydrierungskrise)
• Synchronisation zwischen Geräten über Google-Konto
...
• American Academy of Pediatrics
• Polish Society of Pediatrics (KOMPAS FIEBER)
• WHO-Wachstumsstandards

Richtlinien werden mit offiziellen Empfehlungen aktualisiert — keine Forenratschläge.

⚠️ WICHTIG
Calm Parent ist KEIN Medizinprodukt. Die App berechnet KEINE Medikamentendosen (Dosierung immer im Beipackzettel, bei der Apotheke oder beim Kinderarzt prüfen). Sie stellt KEINE Diagnose und ersetzt KEINEN Arzt — sie hilft Ihnen, Ihr Kind zu beobachten und Daten für den Arztbesuch bereitzuhalten.
...
Ich entwickle diese App allein. Jede Bewertung hilft mir enorm.
...
• Sommeil, siestes, réveils
• Médicaments administrés (heure, dose, historique)
• Couches — mouillées, sales
...
L'essai ne nécessite pas de carte bancaire. Après 14 jours, vous continuez à utiliser la version de base.

✅ TOUJOURS GRATUIT
• Enregistrement de base : température, biberons, sommeil, médicaments
• Alertes de sécurité critiques (fièvre chez les bébés de moins de 3 mois, température ≥40,5°C, crise de déshydratation)
• Synchronisation entre appareils via compte Google
...
• American Academy of Pediatrics
• Polish Society of Pediatrics (KOMPAS FIÈVRE)
• Normes de croissance OMS

Recommandations mises à jour selon les publications officielles — pas de conseils de forum.

⚠️ IMPORTANT
Calm Parent N'EST PAS un dispositif médical. L'application NE calcule PAS les doses de médicaments (vérifiez toujours la notice, avec le pharmacien ou le pédiatre). Elle NE diagnostique PAS et NE remplace PAS un médecin — elle vous aide à observer votre enfant et à avoir des données prêtes pour la visite.
...
Je développe cette application seul. Chaque avis m'aide énormément.
...
• Sueño, siestas, despertares
• Medicamentos administrados (hora, dosis, historial)
• Pañales — mojados, sucios
...
La prueba no requiere tarjeta. Después de 14 días sigues usando la versión básica.

✅ SIEMPRE GRATIS
• Registro básico: temperatura, tomas, sueño, medicamentos
• Alertas críticas de seguridad (fiebre en bebés menores de 3 meses, temperatura ≥40,5°C, crisis de deshidratación)
• Sincronización entre dispositivos con cuenta Google
...
• American Academy of Pediatrics
• Polish Society of Pediatrics (KOMPAS FIEBRE)
• Estándares de crecimiento OMS

Directrices actualizadas según recomendaciones oficiales — no consejos de foros.

⚠️ IMPORTANTE
Calm Parent NO es un dispositivo médico. La aplicación NO calcula dosis de medicamentos (comprueba siempre el prospecto, con el farmacéutico o el pediatra). NO diagnostica y NO sustituye a un médico — te ayuda a observar a tu hijo y tener los datos listos para la consulta.
...
Desarrollo esta aplicación solo. Cada opinión me ayuda enormemente.
