/**
 * Calendario común de vacunación — España (CISNS / CAV-AEP).
 *
 * Source: Calendario común de vacunación a lo largo de toda la vida 2024,
 * Consejo Interterritorial del Sistema Nacional de Salud (CISNS),
 * y recomendaciones del Comité Asesor de Vacunas de la AEP (CAV-AEP).
 *
 * https://www.sanidad.gob.es/areas/promocionPrevencion/vacunaciones/calendario-y-coberturas/
 * https://vacunasaep.org/profesionales/calendario-de-vacunaciones-de-la-aep
 *
 * UWAGA: TY tylko prezentujesz oficjalny hiszpański harmonogram. NIE
 * indywidualizujesz dla konkretnego dziecka. Asesor = Pediatra.
 *
 * Dla LATAM (MX, AR, CO, CL...) używamy tego samego ES UI ale calendarios
 * varían per país. To jest spanish-Spain version. LATAM users dostają
 * disclaimer że to "Calendario español, consultar pediatra para schemat lokalny".
 *
 * Wartości pokazują stan 2024-2025. Aktualizuje się co rok (wrzesień, BOE).
 */
...
export default {
  ...
  schedule: [
    // Vacunas obligatorias y financiadas por SNS (CISNS común a toda España).
    // Esquema 2/4/11 meses (DTPa-Hib-VPI-HepB hexavalente, Pneumocócica, ROR).
    // Plus Meningococo B (recomendada CAV-AEP, financiada en algunas CC.AA.).
  ...
  // Cada Comunidad Autónoma tiene su propio programa, pero el esquema
  // base CISNS/AEP es similar. Aquí: edades comunes a la mayoría de CC.AA.
  uUntersuchungen: [
