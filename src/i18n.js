...
const TRANSLATIONS = {
  pl: {
    ...
    // QuickDoseCard
    'dose.quick.title':             'Szybka dawka — dla {weight} kg',
    'dose.quick.setup':             'Kalkulator dawek — ustaw wagę',
    'dose.quick.setup_desc':        'Bez wagi dziecka nie wyliczę bezpiecznej dawki leku',
    'dose.quick.setup_btn':         'Ustaw',
    'dose.quick.warn_preemie':      'Dziecko < 3 kg — skonsultuj dawki z pediatrą przed podaniem jakiegokolwiek leku.',
    'dose.quick.warn_newborn':      'Noworodek < 1 mies. — skonsultuj dawki z pediatrą przed podaniem.',
    'dose.quick.single':            'Pojedyncza dawka',
    'dose.quick.suspension':        'Zawiesina {strength}',
    'dose.quick.max_daily':         'Max dobowa',
    'dose.quick.max_daily_para':    '4× dziennie co 6h',
    'dose.quick.max_daily_ibu':     '3× dziennie co 8h',
    'dose.quick.ibu_age_limit':     'Ibuprofen tylko od 3. miesiąca życia',
    'dose.quick.ibu_disabled':      'Tylko od 3. miesiąca (obecnie {months} mies.)',
    'dose.quick.save_action':       'Zapisz podanie',
    'dose.quick.disclaimer':        'Kalkulator informacyjny. Zawsze weryfikuj dawki z pediatrą lub farmaceutą.',
    'dose.quick.for_weight':        '{dose} mg dla {weight} kg',
    ...
    'cough.alert.barking':          '🐕 Kaszel szczekający — może wskazywać na krup (zapalenie krtani). Zadzwoń do pediatry, szczególnie jeśli jest gorączka lub świsty.',
    'cough.alert.wheezing':         '💨 Kaszel świszczący — świsty mogą oznaczać obturację oskrzeli. W przypadku duszności natychmiast zgłoś się do pediatry.',
    'cough.alert.long':             '⚠️ Dziecko kaszle od {days} z ostatnich 7 dni — warto umówić wizytę u pediatry.',
    ...
    // Alerts
    'sym.alert.vomit_risk':         '⚠️ {count}× wymioty w 24h — ryzyko odwodnienia. Skonsultuj z pediatrą.',
    'sym.alert.diarrhea_risk':      '⚠️ {count}× biegunka w 24h — ryzyko odwodnienia. Zadzwoń do pediatry.',
    'sym.alert.rash_fever':         '🔴 Wysypka + gorączka — natychmiast do lekarza (może być poważna infekcja).',
    'sym.alert.rash_new':           'ℹ️ Nowa wysypka — obserwuj czy się rozprzestrzenia, sprawdzaj temperaturę.',
    'sym.alert.long':                '⚠️ Dziecko ma objawy od {days} z ostatnich 7 dni — warto umówić wizytę u pediatry.',
  ...
  en: {
    ...
    // QuickDoseCard
    'dose.quick.title':             'Quick dose — for {weight} kg',
    'dose.quick.setup':             'Dose calculator — set baby weight',
    'dose.quick.setup_desc':        'Without baby weight I can not calculate a safe dose',
    'dose.quick.setup_btn':         'Set',
    'dose.quick.warn_preemie':      'Baby < 3 kg — consult pediatrician before giving any medication.',
    'dose.quick.warn_newborn':      'Newborn < 1 month — consult pediatrician before giving medication.',
    'dose.quick.single':            'Single dose',
    'dose.quick.suspension':        'Suspension {strength}',
    'dose.quick.max_daily':         'Max daily',
    'dose.quick.max_daily_para':    '4× daily every 6h',
    'dose.quick.max_daily_ibu':     '3× daily every 8h',
    'dose.quick.ibu_age_limit':     'Ibuprofen only from 3 months of age',
    'dose.quick.ibu_disabled':      'Only from 3 months (currently {months} mo.)',
    'dose.quick.save_action':       'Log dose',
    'dose.quick.disclaimer':        'Informational calculator. Always verify doses with a pediatrician or pharmacist.',
    'dose.quick.for_weight':        '{dose} mg for {weight} kg',

    // DoctorNotesTab
    'doctor.questions.title':       '💬 Questions for next visit',
    'doctor.questions.placeholder': 'Write a question...',
    'doctor.questions.empty':       'No questions yet. Add them as they come to mind — you will see them here before the visit.',
    ...
    'cough.alert.barking':          '🐕 Barking cough — may indicate croup (laryngitis). Call your pediatrician, especially if there is fever or wheezing.',
    'cough.alert.wheezing':         '💨 Wheezing cough — whistling may mean bronchial obstruction. If breathing difficulty appears, seek medical help immediately.',
    'cough.alert.long':             '⚠️ Child has coughed on {days} of the last 7 days — consider scheduling a pediatrician visit.',
    ...
    'sym.alert.vomit_risk':         '⚠️ {count}× vomiting in 24h — dehydration risk. Consult pediatrician.',
    'sym.alert.diarrhea_risk':      '⚠️ {count}× diarrhea in 24h — dehydration risk. Call pediatrician.',
    'sym.alert.rash_fever':         '🔴 Rash + fever — see a doctor immediately (may be serious infection).',
    'sym.alert.rash_new':           'ℹ️ New rash — watch if it spreads, check temperature.',
    'sym.alert.long':                '⚠️ Child has had symptoms on {days} of last 7 days — consider scheduling a pediatrician visit.',
 ...
 *
 * W EN użytkownik widzi tylko: kalkulator dawek + custom dodane rzeczy.
