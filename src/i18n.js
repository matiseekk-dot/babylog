...
const TRANSLATIONS = {
  pl: {
    ...
    'disclaimer.s2.body':          'Aplikacja nie jest wyrobem medycznym. Nie stawia diagnozy. Nie zastępuje lekarza. Nie wylicza dawek leków. Komunikaty w aplikacji (np. "pilna konsultacja", "skontaktuj się z pediatrą") to sugestie oparte o ogólne wytyczne pediatryczne, a nie porada medyczna dla Twojego konkretnego dziecka.',
    ...
    'features.item.crisis.title':   'Wsparcie w kryzysie',
    ...
    'crisis.watch.advice':    'Obserwuj objawy i mierz temperaturę co 2 godziny. Jeśli stan się pogorszy, skontaktuj się z pediatrą.',
    'crisis.call.title':      'Skontaktuj się z pediatrą',
    'crisis.call.action':     'Skontaktuj się ze swoim pediatrą',
    'crisis.call.advice':     'Skorzystaj z numeru do swojej przychodni, teleporady albo umów wizytę online. Wieczorem i w nocy skorzystaj z nocnej i świątecznej pomocy lekarskiej.',
    ...
    // Crisis reasons
    'crisis.reason.very_high':       'Temperatura {temp}°C to bardzo wysoka gorączka',
    'crisis.reason.newborn_emergency':'Niemowlę < 3 mies. z gorączką {temp}°C. Pilna ocena lekarska.',
    'crisis.reason.newborn_call':    'Niemowlę < 3 mies. z gorączką {temp}°C. Skonsultuj z pediatrą.',
    'crisis.reason.young_infant':    'Dziecko 3-6 mies. z gorączką {temp}°C. Skontaktuj się z pediatrą.',
    ...
    // Rules engine
    'rule.temp_infant.title':      'Pilna konsultacja pediatryczna',
    'rule.temp_infant.msg':        'Temperatura {temp}°C u niemowlęcia poniżej 3. mies. ({months} mies.) to wskazanie do pilnej oceny lekarskiej. Skontaktuj się z pediatrą lub udaj do szpitala.',
    'rule.temp_young_infant.title':'Gorączka u niemowlęcia',
    'rule.temp_young_infant.msg': 'Temperatura {temp}°C u dziecka 3-6 mies. ({months} mies.). Skontaktuj się z pediatrą — u małych niemowląt gorączka wymaga oceny nawet przy niższych wartościach.',
    'rule.temp_extreme.title':     'Bardzo wysoka gorączka',
    'rule.temp_extreme.msg':       'Temperatura {temp}°C. Wartość powyżej 40,5°C to sytuacja pilna — skontaktuj się niezwłocznie z lekarzem lub udaj na izbę przyjęć.',
    'rule.temp_alert.title':       'Wysoka gorączka',
    'rule.temp_alert.msg':         'Ostatni pomiar: {temp}°C. Obserwuj dziecko i rozważ podanie leku przeciwgorączkowego zgodnie z zaleceniami.',
    'rule.temp_critical.title':    'Gorączka krytyczna',
    'rule.temp_critical.msg':      'Temperatura {temp}°C — skontaktuj się z pediatrą. Jeśli dziecko źle wygląda, jest apatyczne lub ma inne niepokojące objawy, udaj się na izbę przyjęć.',
    ...
    'rule.med_not_working.title':  'Gorączka nie spada mimo leku',
    'rule.med_not_working.msg':    'Temperatura nie spadła po {med} ({hours}h temu). NIE podawaj kolejnej dawki poza zaleceniami — skontaktuj się z pediatrą.',
    'rule.med_too_soon.title':     'Odstęp między dawkami',
    'rule.med_too_soon.para':      'Kolejną dawkę paracetamolu możesz podać za {hours}h {mins}min (minimum 4h między dawkami).',
    'rule.med_too_soon.ibu':       'Kolejną dawkę ibuprofenu możesz podać za {hours}h {mins}min (minimum 6h między dawkami).',
    'rule.med_limit.title':        'Osiągnięto limit dawek',
    'rule.med_limit.para':         'Paracetamol: {count} dawek w ostatnich 24h. Nie podawaj więcej bez konsultacji z lekarzem (max 4 dawki / 24h).',
    'rule.med_limit.ibu':          'Ibuprofen: {count} dawek w ostatnich 24h. Nie podawaj więcej bez konsultacji z lekarzem (max 4 dawki / 24h).',
    ...
    'rule.med_expired.title':      'Minął czas działania leku',
    'rule.med_expired.msg':        '{name} podano {hours}h {mins}min temu. Jeśli gorączka się utrzymuje, obserwuj dziecko. Kolejną dawkę podaj tylko jeśli zachowany jest bezpieczny odstęp i limit dobowy.',
  ...
  en: {
    ...
    'disclaimer.s2.body':          'This app is not a medical device. It does not diagnose. It does not replace a doctor. It does not calculate medication doses. Messages in the app (like "urgent consultation" or "contact your pediatrician") are suggestions based on general pediatric guidelines, not medical advice for your specific child.',
    ...
    'features.item.temp.detail':    'Take temperature, log it. The app shows a chart and alerts you when fever rises, persists over 72h, or crosses thresholds requiring a pediatrician consultation.',
    'features.item.meds.emoji':     '💊',
    ...
    'features.item.symptoms.detail':'Log symptoms with one tap. The app alerts you when vomiting is frequent in a short time, when rash and fever appear together, etc.',

    // Health
    'features.item.crisis.emoji':   '🚨',
    'features.item.crisis.title':   'Support during a crisis',
    ...
    'crisis.watch.advice':    'Observe symptoms and measure temperature every 2 hours. If condition worsens, contact your pediatrician.',
    'crisis.call.title':      'Contact your pediatrician',
    ...
    // Crisis reasons
    'crisis.reason.very_high':       'Temperature {temp}°C is a very high fever',
    'crisis.reason.newborn_emergency':'Infant under 3 mo with fever {temp}°C. Urgent medical evaluation needed.',
    'crisis.reason.newborn_call':    'Infant under 3 mo with fever {temp}°C. Consult your pediatrician.',
    'crisis.reason.young_infant':    '3-6 month old with fever {temp}°C. Contact your pediatrician.',
    'crisis.reason.high_fever':      'High fever {temp}°C',
    'crisis.reason.watch':           'Fever {temp}°C. Monitor every 1-2h.',
    'crisis.reason.prolonged':       'Fever lasting over 72h. Consultation needed.',
    // Rules engine
    'rule.temp_infant.title':      'Urgent pediatric consultation',
    'rule.temp_infant.msg':        'Temperature {temp}°C in an infant under 3 months ({months} mo.) requires urgent medical evaluation. Contact your pediatrician or go to the hospital.',
    'rule.temp_young_infant.title':'Fever in a young infant',
    'rule.temp_young_infant.msg': 'Temperature {temp}°C in a 3-6 month old ({months} mo.). Contact your pediatrician — young infants need evaluation even with lower fever readings.',
    'rule.temp_extreme.title':     'Very high fever',
    'rule.temp_extreme.msg':       'Temperature {temp}°C. A reading above 40.5°C is an urgent situation — contact a doctor immediately or go to the ER.',
    'rule.temp_alert.title':       'High fever',
    'rule.temp_alert.msg':         'Last reading: {temp}°C. Monitor your child closely and consider a fever-reducing medicine according to dosing guidelines.',
    'rule.temp_critical.title':    'Critical fever',
    'rule.temp_critical.msg':      "Temperature {temp}°C — contact your pediatrician. If your child looks unwell, is lethargic or has other concerning symptoms, go to the ER.",
    ...
    'rule.med_not_working.title':  'Fever not responding to medication',
    'rule.med_not_working.msg':    "Temperature did not drop after {med} ({hours}h ago). Do NOT give another dose outside recommended intervals — contact your pediatrician.",
    'rule.med_too_soon.title':     'Interval between doses',
    'rule.med_too_soon.para':      'Next paracetamol dose can be given in {hours}h {mins}min (minimum 4h between doses).',
    'rule.med_too_soon.ibu':       'Next ibuprofen dose can be given in {hours}h {mins}min (minimum 6h between doses).',
    'rule.med_limit.title':        'Daily dose limit reached',
    'rule.med_limit.para':         "Paracetamol: {count} doses in the last 24h. Don't give more without consulting a doctor (max 4 doses / 24h).",
    'rule.med_limit.ibu':          "Ibuprofen: {count} doses in the last 24h. Don't give more without consulting a doctor (max 4 doses / 24h).",
    ...
    'rule.med_expired.title':      'Medication duration has passed',
    'rule.med_expired.msg':        '{name} was given {hours}h {mins}min ago. If fever persists, monitor your child. Only give the next dose if the safe interval and daily limit are respected.',
